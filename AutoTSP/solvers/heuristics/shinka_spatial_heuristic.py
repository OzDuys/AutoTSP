...
"""
Shinka spatial heuristic for Euclidean-style TSP instances.
...
class ShinkaSpatialHeuristicSolver(BaseSolver):
    name = "shinka_spatial_heuristic"
...
__all__ = ["ShinkaSpatialHeuristicSolver"]
